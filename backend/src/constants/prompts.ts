...
export const PROMPT_DescribeYourWord =`第【round】轮 【描述阶段】，第【order】位发言者是你，请你现在对你分配到的词“【词】”用一个短语进行描述，避免说出这个词，如果万不得已必须要提到“【词】”则用“我的这个词”代替。注意：千万不要流露出内心想法，能说出来的必须是在这场游戏中可以公开讲的内容。回复格式要求：只要回复你的描述短语，不要有任何多余内容。`;
