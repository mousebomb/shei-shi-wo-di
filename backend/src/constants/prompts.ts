 ...
 * 占位符：【round】【词】【长度要求】
 */
export const PROMPT_DescribeYourWord = `第【round】轮 【描述阶段】，现在轮到你描述"【词】"。
注意：
- 不能在描述中包含"【词】"，如果必须提到则用"我这个词"代替
- 不要和已有描述重复
- 千万不要流露出内心真实想法，能说出来的必须是在游戏中可以公开讲的内容
- 只回复你的描述，不要有任何多余内容
- 【长度要求】`;
...
export const PROMPT_Vote = `第【round】轮 【投票阶段】，现在轮到你投票。得票最多的人将会出局。你说的每一句话都不可以包含"【词】"。因为你想要活到最后，所以不可以投票给自己。回复格式要求：以json格式回复，格式为：{"voteToPlayer":number,"reason":string}，例如：{"voteToPlayer":1,"reason":"理由"}。`;
